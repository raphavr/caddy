...
You can have a direct impact on the project by helping with its code. To contribute code to Caddy, open a [pull request](https://github.com/raphavr/caddy/pulls) (PR). If you're new to our community, that's okay: **we gladly welcome pull requests from anyone, regardless of your native language or coding experience.** You can get familiar with Caddy's code base by using [code search at Sourcegraph](https://sourcegraph.com/github.com/raphavr/caddy/-/search).
...
1. [Fork this repo](https://github.com/raphavr/caddy). This makes a copy of the code you can write to.

2. If you don't already have this repo (mholt/caddy.git) repo on your computer, get it with `go get github.com/raphavr/caddy/caddy`.
...
6. [Create a pull request](https://github.com/raphavr/caddy/pull/new/master) to merge your changes into mholt/caddy @ master. (Click "compare across forks" and change the head fork.)
...
[Learn how to write and submit a plugin](https://github.com/raphavr/caddy/wiki) on the wiki. You should also share and discuss your plugin idea [on the forums](https://caddy.community) to have people test it out. We don't use the Caddy issue tracker for plugins.
...
Like every software, Caddy has its flaws. If you find one, [search the issues](https://github.com/raphavr/caddy/issues) to see if it has already been reported. If not, [open a new issue](https://github.com/raphavr/caddy/issues/new) and describe the bug, and somebody will look into it! (This repository is only for Caddy, not plugins.)
